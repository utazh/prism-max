...
from h2o_flexgen.flexgen.pytorch_backend_bk import LlamaTorchDevice, TorchDisk, TorchMixedDevice, fix_recursive_import
from h2o_flexgen.flexgen.flex_opt_bk import (Policy, init_weight_list, InputEmbed, OutputEmbed, SelfAttention, MLP,
...
class LlamaSelfAttention(SelfAttention):
    ...
    def forward(self, hidden, cache_read_buf, weight_read_buf, attention_mask,
        ...
        if i == 0:  # prefill
            ...
            cache_write_buf.store((new_k_cache, new_v_cache,None,None))
        else:  # decoding
...
def add_parser_arguments(parser):
    ...
    parser.add_argument("--log-file", type=str, default="llama.log")
