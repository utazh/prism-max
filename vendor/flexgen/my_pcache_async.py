...
class PrefixKVLayer():
    ...
    def prefetch_by_chunk(self,pos_id=None,need_key=True,need_value=True,k_v_num_tokens=None,time_budget=0.0):
        ...
        if len(pos_id.shape) == 1:
            ...
            key_buffer, value_buffer, pinned_buffers = self._prefetch_by_chunk_pinned(
                chunk_ids=chunk_ids,
                prefetch_tokenids=prefetch_tokenids,
                need_key=need_key,
...
class Pcache():
    ...
    def prefetch_async(self, prefix_id, pos_id=None, layer=None, k_v_num_tokens=None, time_budget=0.0):
        def _run_prefetch():
        ...
        return AsyncPrefetchHandle(self._prefetch_executor.submit(_run_prefetch))
